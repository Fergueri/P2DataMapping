async function universityGraph() { // Fetch and parse the CSV data
    const url = "https://fergueri.github.io/P2DataMapping/CSV/UNIvsCPI.csv";
    ...
    const datasets = [
        {
            label: 'University Rate Using CPI',
            data: csvData.map((row) => row['University Rate Using CPI']),
    ...
    const ctx = document.getElementById('universityGraph').getContext('2d');
    ...
    const options = {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: 'Comparison of Actual vs Inflation-Adjusted University Expenditures in Toronto',
                font: {
                    size: 30,
                    family: "BebasNeue"
                },
